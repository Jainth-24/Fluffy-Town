...
export function Icon({ children, className, fill = 'currentColor', stroke, ...props }: IconProps) {
  return (
    <svg
...
export function IconArrow({ direction = 'right' }: IconProps) {
  ...
  return (
    <Icon className={clsx('size-5', rotate)}>
      <title>Arrow</title>
...
export function IconCaret({ direction = 'down', stroke = 'currentColor', ...props }: IconProps) {
  ...
  return (
    <Icon {...props} className={clsx('size-5 transition', rotate)} fill="transparent" stroke={stroke}>
      <title>Caret</title>
