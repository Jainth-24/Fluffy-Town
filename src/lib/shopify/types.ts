...
export type SellingPlanCheckoutChargeValue = Money | SellingPlanCheckoutChargePercentageValue;
...
export type DiscountApplicationConnection = {
  ...
  nodes: Array<
    AutomaticDiscountApplication | DiscountCodeApplication | ManualDiscountApplication | ScriptDiscountApplication
  >;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};
