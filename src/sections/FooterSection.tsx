...
const FooterSection = (props: any) => {
  ...
  return (
    <footer
      ...
      className=" text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 text-center lg:text-left"
    >
      <div className="border-neutral-200 dark:border-neutral-500 flex items-center justify-center border-b-2 p-6 lg:justify-between">
        <div className="mr-12 hidden lg:block">
          <span>Get connected with us on social networks:</span>
        </div>
        <div className="flex justify-center">
          <a href="#!" className="text-neutral-600 dark:text-neutral-200 mr-6">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            <Image alt="" src={shop.brand.logo.image.url} width={50} height={50} />
          ...
          <div className="">
            ...
            {menu.items.map((item: any) => (
              <p className="mb-4" key={item.id}>
                <a href={item.url} className="text-neutral-600 dark:text-neutral-200">
                  {item.title}
                </a>
              </p>
            ))}
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="mr-3 size-5">
                <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" />
                <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
              </svg>
              Fluffy Town Power House, Uthukuli – 638751
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="mr-3 size-5">
          ...
          <div>
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Location</h6>
            {/* Google Maps iframe */}
            <div className="mb-4">
              <iframe
                title="Google Maps"
      ...
      <div className="bg-neutral-200 dark:bg-neutral-700 p-6 text-center">
        ...
        <a className="text-neutral-600 dark:text-neutral-400 font-semibold" href="https://tw-elements.com/">
          {shop.name}
        </a>
      </div>
    </footer>
