...
type ZEUS_UNIONS =
  | GraphQLTypes['DeliveryAddress']
  | GraphQLTypes['Merchandise']
  | GraphQLTypes['MetafieldParentResource']
  | GraphQLTypes['MetafieldReference']
  | GraphQLTypes['PricingValue']
  | GraphQLTypes['SellingPlanCheckoutChargeValue']
  | GraphQLTypes['SellingPlanPriceAdjustmentValue'];
 ...
 */
  ...
  ['Article']: AliasType<{
    ...
    comments?: [
      {
        ...
        first?:
          ...
          | undefined
          | null
          | Variable<any, string> /** Returns the elements that come after the specified cursor. */;
        after?:
          | string
          | undefined
          | null
          | Variable<any, string> /** Returns up to the last `n` elements from the list. */;
        last?:
          | number
          | undefined
          | null
          | Variable<any, string> /** Returns the elements that come before the specified cursor. */;
    ...
    content?: [
      {
        /** Truncates string after the given length. */ truncateAt?: number | undefined | null | Variable<any, string>;
      },
      boolean | `@${string}`
    ];
 ...
 */
  ...
  ['Blog']: AliasType<{
    articleByHandle?: [
      {
        /** The handle of the article. */ handle: string | Variable<any, string>;
      },
      ValueTypes['Article']
    ];
    articles?: [
      {
        ...
        sortKey?:
          | ValueTypes['ArticleSortKeys']
          | undefined
          | null
          | Variable<any, string> /** Supported filter parameters:
 - `author`
 - `blog_title`
 - `created_at`
 - `tag`
 ...
 */
  ['Cart']: AliasType<{
    attribute?: [
      {
        /** The key of the attribute. */ key: string | Variable<any, string>;
      },
 ...
 */
  ...
  ['CartDiscountAllocation']: AliasType<{
    /** The discounted amount that has been applied to the cart line. */
    discountedAmount?: ValueTypes['MoneyV2'];
    ['...on CartAutomaticDiscountAllocation']?: Omit<
      ValueTypes['CartAutomaticDiscountAllocation'],
      keyof ValueTypes['CartDiscountAllocation']
    >;
    ['...on CartCodeDiscountAllocation']?: Omit<
      ValueTypes['CartCodeDiscountAllocation'],
      keyof ValueTypes['CartDiscountAllocation']
    >;
    ['...on CartCustomDiscountAllocation']?: Omit<
      ValueTypes['CartCustomDiscountAllocation'],
      keyof ValueTypes['CartDiscountAllocation']
    >;
    __typename?: boolean | `@${string}`;
  }>;
    ...
    products?: [
      {
        ...
        reverse?: boolean | undefined | null | Variable<any, string> /** Sort the underlying list by the given key. */;
        sortKey?:
          | ValueTypes['ProductCollectionSortKeys']
          | undefined
          | null
          | Variable<any, string> /** Returns a subset of products matching all product filters. */;
 ...
 */
  ['DiscountApplication']: AliasType<{
    ...
    /** The value of the discount application. */
    value?: ValueTypes['PricingValue'];
    ['...on AutomaticDiscountApplication']?: Omit<
      ValueTypes['AutomaticDiscountApplication'],
      keyof ValueTypes['DiscountApplication']
    >;
    ['...on DiscountCodeApplication']?: Omit<
      ValueTypes['DiscountCodeApplication'],
      keyof ValueTypes['DiscountApplication']
    >;
    ['...on ManualDiscountApplication']?: Omit<
      ValueTypes['ManualDiscountApplication'],
      keyof ValueTypes['DiscountApplication']
    >;
    ['...on ScriptDiscountApplication']?: Omit<
      ValueTypes['ScriptDiscountApplication'],
      keyof ValueTypes['DiscountApplication']
    >;
    __typename?: boolean | `@${string}`;
  }>;
 ...
 */
  ...
  ['Fulfillment']: AliasType<{
    ...
    trackingInfo?: [
      {
        /** Truncate the array result to this size. */ first?: number | undefined | null | Variable<any, string>;
      },
    ...
    transformedSrc?: [
      {
        ...
        maxHeight?:
          ...
          | undefined
          | null
          | Variable<any, string> /** Crops the image according to the specified region. */;
        crop?:
    ...
    formatted?: [
      {
        ...
        withName?:
          ...
          | undefined
          | null
          | Variable<any, string> /** Whether to include the customer's company in the formatted address. */;
 ...
 */
  ...
  ['Metaobject']: AliasType<{
    field?: [
      {
        /** The key of the field. */ key: string | Variable<any, string>;
      },
 ...
 */;
    ...
    cartLinesRemove?: [
      {
        /** The ID of the cart. */ cartId: string | Variable<any, string> /** The merchandise line IDs to remove. */;
    ...
    cartLinesUpdate?: [
      {
        /** The ID of the cart. */ cartId: string | Variable<any, string> /** The merchandise lines to update. */;
    ...
    cartNoteUpdate?: [
      {
        /** The ID of the cart. */ cartId: string | Variable<any, string> /** The note on the cart. */;
        note?: string | undefined | null | Variable<any, string>;
      },
    ...
    cartSelectedDeliveryOptionsUpdate?: [
      {
        /** The ID of the cart. */ cartId: string | Variable<any, string> /** The selected delivery options. */;
    ...
    checkoutCompleteFree?: [
      {
        /** The ID of the checkout. */ checkoutId: string | Variable<any, string>;
      },
    ...
    checkoutCreate?: [
      {
        ...
        input:
          | ValueTypes['CheckoutCreateInput']
          | Variable<any, string> /** The checkout queue token. Available only to selected stores. */;
    ...
    customerAccessTokenDelete?: [
      {
        /** The access token used to identify the customer. */ customerAccessToken: string | Variable<any, string>;
      },
    ...
    customerDefaultAddressUpdate?: [
      {
        ...
        customerAccessToken:
          | string
          | Variable<any, string> /** ID of the address to set as the new default for the customer. */;
    ...
    customerRecover?: [
      {
        /** The email address of the customer to recover. */ email: string | Variable<any, string>;
      },
    ...
    customerResetByUrl?: [
      {
        ...
        resetUrl:
          | ValueTypes['URL']
          | Variable<any, string> /** New password that will be set as part of the reset password process. */;
        password: string | Variable<any, string>;
      },
    ...
    storeAvailability?: [
      {
        ...
        reverse?:
          ...
          | undefined
          | null
          | Variable<any, string> /** Used to sort results based on proximity to the provided location. */;
 ...
 */;
    ...
    blogByHandle?: [
      {
        /** The handle of the blog. */ handle: string | Variable<any, string>;
      },
      ValueTypes['Blog']
    ];
    blogs?: [
 ...
 */;
    ...
    cart?: [
      {
        /** The ID of the cart. */ id: string | Variable<any, string>;
      },
      ValueTypes['Cart']
    ];
    collection?: [
    ...
    collectionByHandle?: [
      {
        /** The handle of the collection. */ handle: string | Variable<any, string>;
      },
      ValueTypes['Collection']
    ];
    collections?: [
 ...
 */;
    ...
    customer?: [
      {
        /** The customer access token. */ customerAccessToken: string | Variable<any, string>;
      },
      ValueTypes['Customer']
    ];
    ...
    menu?: [
      {
        /** The navigation menu's handle. */ handle: string | Variable<any, string>;
      },
      ValueTypes['Menu']
    ];
    metaobject?: [
    ...
    metaobjects?: [
      {
        ...
        sortKey?:
          ...
          | undefined
          | null
          | Variable<any, string> /** Returns up to the first `n` elements from the list. */;
        first?:
          | number
          | undefined
          | null
    ...
    node?: [
      {
        /** The ID of the Node to return. */ id: string | Variable<any, string>;
      },
      ValueTypes['Node']
    ];
    nodes?: [
      {
        /** The IDs of the Nodes to return. */ ids: Array<string> | Variable<any, string>;
      },
      ValueTypes['Node']
    ];
    page?: [
    ...
    pageByHandle?: [
      {
        /** The handle of the page. */ handle: string | Variable<any, string>;
      },
      ValueTypes['Page']
    ];
    pages?: [
 ...
 */;
    ...
    productRecommendations?: [
      {
        /** The id of the product. */ productId: string | Variable<any, string>;
      },
      ValueTypes['Product']
    ];
    productTags?: [
      {
        /** Returns up to the first `n` elements from the list. */ first: number | Variable<any, string>;
      },
 ...
 */
  ...
  ['Article']: AliasType<{
    ...
    content?: [
      {
        /** Truncates string after the given length. */ truncateAt?: number | undefined | null;
      },
      boolean | `@${string}`
    ];
    /** The content of the article, complete with HTML formatting. */
    ...
    metafield?: [
      {
        /** A container for a set of metafields. */ namespace: string /** The identifier for the metafield. */;
        key: string;
      },
 ...
 */
  ...
  ['Blog']: AliasType<{
    articleByHandle?: [
      {
        /** The handle of the article. */ handle: string;
      },
 ...
 */
  ['Cart']: AliasType<{
    attribute?: [
      {
        /** The key of the attribute. */ key: string;
      },
 ...
 */
  ...
  ['CartDiscountAllocation']: AliasType<{
    ...
    discountedAmount?: ResolverInputTypes['MoneyV2'];
    ['...on CartAutomaticDiscountAllocation']?: Omit<
      ResolverInputTypes['CartAutomaticDiscountAllocation'],
      keyof ResolverInputTypes['CartDiscountAllocation']
    >;
    ['...on CartCodeDiscountAllocation']?: Omit<
      ResolverInputTypes['CartCodeDiscountAllocation'],
      keyof ResolverInputTypes['CartDiscountAllocation']
    >;
    ['...on CartCustomDiscountAllocation']?: Omit<
      ResolverInputTypes['CartCustomDiscountAllocation'],
      keyof ResolverInputTypes['CartDiscountAllocation']
    >;
    __typename?: boolean | `@${string}`;
  }>;
    ...
    products?: [
      {
        ...
        reverse?: boolean | undefined | null /** Sort the underlying list by the given key. */;
        sortKey?:
          | ResolverInputTypes['ProductCollectionSortKeys']
          | undefined
          | null /** Returns a subset of products matching all product filters. */;
 ...
 */
  ['DiscountApplication']: AliasType<{
    ...
    value?: ResolverInputTypes['PricingValue'];
    ['...on AutomaticDiscountApplication']?: Omit<
      ResolverInputTypes['AutomaticDiscountApplication'],
      keyof ResolverInputTypes['DiscountApplication']
    >;
    ['...on DiscountCodeApplication']?: Omit<
      ResolverInputTypes['DiscountCodeApplication'],
      keyof ResolverInputTypes['DiscountApplication']
    >;
    ['...on ManualDiscountApplication']?: Omit<
      ResolverInputTypes['ManualDiscountApplication'],
      keyof ResolverInputTypes['DiscountApplication']
    >;
    ['...on ScriptDiscountApplication']?: Omit<
      ResolverInputTypes['ScriptDiscountApplication'],
      keyof ResolverInputTypes['DiscountApplication']
    >;
    __typename?: boolean | `@${string}`;
  }>;
 ...
 */
  ...
  ['DisplayableError']: AliasType<{
    ...
    ['...on CheckoutUserError']?: Omit<
      ResolverInputTypes['CheckoutUserError'],
      keyof ResolverInputTypes['DisplayableError']
    >;
    ['...on CustomerUserError']?: Omit<
      ResolverInputTypes['CustomerUserError'],
      keyof ResolverInputTypes['DisplayableError']
    >;
 ...
 */
  ...
  ['Fulfillment']: AliasType<{
    ...
    trackingInfo?: [
      {
        /** Truncate the array result to this size. */ first?: number | undefined | null;
      },
    ...
    transformedSrc?: [
      {
        ...
        crop?:
          | ResolverInputTypes['CropRegion']
          | undefined
          | null /** Image size multiplier for high-resolution retina displays. Must be between 1 and 3. */;
        scale?:
          | number
          | undefined
          | null /** Best effort conversion of image into content type (SVG -> PNG, Anything -> JPG, Anything -> WEBP are supported). */;
    ...
    formatted?: [
      {
        ...
        withName?:
          | boolean
          | undefined
          | null /** Whether to include the customer's company in the formatted address. */;
 ...
 */
  ...
  ['Metaobject']: AliasType<{
    field?: [
      {
        /** The key of the field. */ key: string;
      },
 ...
 */;
    ...
    cartCreate?: [
      {
        /** The fields used to create a cart. */ input?: ResolverInputTypes['CartInput'] | undefined | null;
      },
    ...
    cartLinesRemove?: [
      {
        /** The ID of the cart. */ cartId: string /** The merchandise line IDs to remove. */;
    ...
    cartLinesUpdate?: [
      {
        /** The ID of the cart. */ cartId: string /** The merchandise lines to update. */;
    ...
    cartNoteUpdate?: [
      {
        /** The ID of the cart. */ cartId: string /** The note on the cart. */;
        note?: string | undefined | null;
      },
    ...
    cartSelectedDeliveryOptionsUpdate?: [
      {
        /** The ID of the cart. */ cartId: string /** The selected delivery options. */;
    ...
    checkoutAttributesUpdateV2?: [
      {
        /** The ID of the checkout. */ checkoutId: string /** The checkout attributes to update. */;
    ...
    checkoutCompleteFree?: [
      {
        /** The ID of the checkout. */ checkoutId: string;
      },
      ResolverInputTypes['CheckoutCompleteFreePayload']
    ];
    checkoutCompleteWithCreditCardV2?: [
      {
        /** The ID of the checkout. */ checkoutId: string /** The credit card info to apply as a payment. */;
    ...
    checkoutCompleteWithTokenizedPaymentV3?: [
      {
        /** The ID of the checkout. */ checkoutId: string /** The info to apply as a tokenized payment. */;
    ...
    checkoutDiscountCodeApplyV2?: [
      {
        /** The discount code to apply to the checkout. */ discountCode: string /** The ID of the checkout. */;
        checkoutId: string;
      },
    ...
    checkoutEmailUpdateV2?: [
      {
        /** The ID of the checkout. */ checkoutId: string /** The email to update the checkout with. */;
        email: string;
      },
    ...
    checkoutLineItemsRemove?: [
      {
        /** The checkout on which to remove line items. */ checkoutId: string /** Line item ids to remove. */;
    ...
    checkoutLineItemsUpdate?: [
      {
        /** The checkout on which to update line items. */ checkoutId: string /** Line items to update. */;
    ...
    customerAccessTokenCreateWithMultipass?: [
      {
        /** A valid [multipass token](https://shopify.dev/api/multipass) to be authenticated. */ multipassToken: string;
      },
      ResolverInputTypes['CustomerAccessTokenCreateWithMultipassPayload']
    ];
    customerAccessTokenDelete?: [
      {
        /** The access token used to identify the customer. */ customerAccessToken: string;
      },
    ...
    customerActivate?: [
      {
        /** Specifies the customer to activate. */ id: string /** The fields used to activate a customer. */;
    ...
    customerAddressDelete?: [
      {
        /** Specifies the address to delete. */ id: string /** The access token used to identify the customer. */;
        customerAccessToken: string;
      },
    ...
    customerCreate?: [
      {
        /** The fields used to create a new customer. */ input: ResolverInputTypes['CustomerCreateInput'];
      },
    ...
    customerRecover?: [
      {
        /** The email address of the customer to recover. */ email: string;
      },
      ResolverInputTypes['CustomerRecoverPayload']
    ];
    customerReset?: [
      {
        /** Specifies the customer to reset. */ id: string /** The fields used to reset a customer’s password. */;
 ...
 */;
    ...
    blog?: [
      {
        /** The ID of the `Blog`. */ id?: string | undefined | null /** The handle of the `Blog`. */;
    ...
    blogByHandle?: [
      {
        /** The handle of the blog. */ handle: string;
      },
      ResolverInputTypes['Blog']
    ];
    blogs?: [
 ...
 */;
    ...
    cart?: [
      {
        /** The ID of the cart. */ id: string;
      },
      ResolverInputTypes['Cart']
    ];
    collection?: [
      {
        /** The ID of the `Collection`. */ id?: string | undefined | null /** The handle of the `Collection`. */;
        handle?: string | undefined | null;
      },
    ...
    collectionByHandle?: [
      {
        /** The handle of the collection. */ handle: string;
      },
      ResolverInputTypes['Collection']
    ];
    collections?: [
 ...
 */;
    ...
    customer?: [
      {
        /** The customer access token. */ customerAccessToken: string;
      },
    ...
    locations?: [
      {
        ...
        reverse?: boolean | undefined | null /** Sort the underlying list by the given key. */;
        sortKey?:
          | ResolverInputTypes['LocationSortKeys']
          | undefined
          | null /** Used to sort results based on proximity to the provided location. */;
        near?: ResolverInputTypes['GeoCoordinateInput'] | undefined | null;
      },
    ...
    menu?: [
      {
        /** The navigation menu's handle. */ handle: string;
      },
      ResolverInputTypes['Menu']
    ];
    metaobject?: [
      {
        /** The ID of the metaobject. */ id?: string | undefined | null /** The handle and type of the metaobject. */;
    ...
    node?: [
      {
        /** The ID of the Node to return. */ id: string;
      },
      ResolverInputTypes['Node']
    ];
    nodes?: [
      {
        /** The IDs of the Nodes to return. */ ids: Array<string>;
      },
      ResolverInputTypes['Node']
    ];
    page?: [
      {
        /** The ID of the `Page`. */ id?: string | undefined | null /** The handle of the `Page`. */;
        handle?: string | undefined | null;
      },
    ...
    pageByHandle?: [
      {
        /** The handle of the page. */ handle: string;
      },
      ResolverInputTypes['Page']
    ];
    pages?: [
 ...
 */;
    ...
    product?: [
      {
        /** The ID of the `Product`. */ id?: string | undefined | null /** The handle of the `Product`. */;
        handle?: string | undefined | null;
      },
    ...
    productRecommendations?: [
      {
        /** The id of the product. */ productId: string;
      },
      ResolverInputTypes['Product']
    ];
    productTags?: [
      {
        /** Returns up to the first `n` elements from the list. */ first: number;
      },
 ...
 */
  ...
  ['CartDiscountAllocation']:
    | ModelTypes['CartAutomaticDiscountAllocation']
    | ModelTypes['CartCodeDiscountAllocation']
    | ModelTypes['CartCustomDiscountAllocation'];
  /** The discount codes applied to the cart. */
  ['CartDiscountCode']: {
    /** Whether the discount code is applicable to the cart's current contents. */
    applicable: boolean;
 ...
 */
  ['DiscountApplication']:
    | ModelTypes['AutomaticDiscountApplication']
    | ModelTypes['DiscountCodeApplication']
    | ModelTypes['ManualDiscountApplication']
    | ModelTypes['ScriptDiscountApplication'];
  ['DiscountApplicationAllocationMethod']: DiscountApplicationAllocationMethod;
  /** An auto-generated type for paginating through multiple DiscountApplications.
   */
 ...
 */
  ...
  /** Represents an error in the input of a mutation. */
  ['DisplayableError']:
    | ModelTypes['CartUserError']
    | ModelTypes['CheckoutUserError']
    | ModelTypes['CustomerUserError']
    | ModelTypes['UserError'];
  /** Represents a web address. */
  ['Domain']: {
    /** The host name of the domain (eg: `example.com`). */
    host: string;
 ...
 */
  ...
  ['MetafieldReference']:
    | ModelTypes['Collection']
    | ModelTypes['GenericFile']
    | ModelTypes['MediaImage']
    | ModelTypes['Metaobject']
    | ModelTypes['Page']
    | ModelTypes['Product']
    | ModelTypes['ProductVariant']
    | ModelTypes['Video'];
 ...
 */
  ['Node']:
    | ModelTypes['AppliedGiftCard']
    | ModelTypes['Article']
    | ModelTypes['Blog']
    | ModelTypes['Cart']
    | ModelTypes['CartLine']
    | ModelTypes['Checkout']
    | ModelTypes['CheckoutLineItem']
    | ModelTypes['Collection']
    | ModelTypes['Comment']
    | ModelTypes['ExternalVideo']
    | ModelTypes['GenericFile']
    | ModelTypes['Location']
    | ModelTypes['MailingAddress']
    | ModelTypes['MediaImage']
    | ModelTypes['Menu']
    | ModelTypes['MenuItem']
    | ModelTypes['Metafield']
    | ModelTypes['Metaobject']
    | ModelTypes['Model3d']
    | ModelTypes['Order']
    | ModelTypes['Page']
    ...
    | ModelTypes['ProductVariant']
    | ModelTypes['Shop']
    | ModelTypes['ShopPolicy']
    | ModelTypes['UrlRedirect']
    | ModelTypes['Video'];
  /** Represents a resource that can be published to the Online Store sales channel. */
...
Individual selling plans contribute their options to the associated selling plan group. For example, a selling plan group might have an option called `option1: Delivery every`. One selling plan in that group could contribute `option1: 2 weeks` with the pricing for that option, and another selling plan could contribute `option1: 4 weeks`, with different pricing. */
  ...
  ['SellingPlanPriceAdjustmentValue']:
    | ModelTypes['SellingPlanFixedAmountPriceAdjustment']
    | ModelTypes['SellingPlanFixedPriceAdjustment']
    | ModelTypes['SellingPlanPercentagePriceAdjustment'];
  /** A shipping rate to be applied to a checkout. */
  ['ShippingRate']: {
    /** Human-readable unique identifier for this shipping rate. */
    handle: string;
 ...
 */
  ...
  ['SellingPlanCheckoutChargeValue']: {
    ...
    ['...on MoneyV2']: '__union' & GraphQLTypes['MoneyV2'];
    ['...on SellingPlanCheckoutChargePercentageValue']: '__union' &
      GraphQLTypes['SellingPlanCheckoutChargePercentageValue'];
  };
  /** An auto-generated type for paginating through multiple SellingPlans.
   */
  ['SellingPlanConnection']: {
